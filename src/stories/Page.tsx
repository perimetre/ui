 ...
 * @param props.onLogin onLoginCallback
 * @param props.onLogout onLogoutCallback
 * @param props.onCreateAccount onCreateAccount callback
 *
 * @returns Storybook initial page
 */
