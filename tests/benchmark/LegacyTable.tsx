...
import Display from '../../components/legacy/Display';
import Text from '../../components/legacy/Text';
import Spacing from '../../components/legacy/Spacing';
...
const LegacyTable: React.FC<LegacyTableProps> = ({ rows }) => {
  return (
    <table>
      {rows &&
        rows.map((row, index) => {
            ...
            <React.Fragment key={row.id}>
              {index === 0 && (
                <thead>
                  <tr>
                    <Text.TH>
                      <Display display="flex" gapHorizontal="px8" alignItems="center" cursor="pointer">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <Spacing marginVertical="px8" gapVertical="px4">
                    ...
                    <Text.Span fontSize="text-base" color="paragraph" numberOfLines={1}>
